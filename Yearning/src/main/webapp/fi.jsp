        ...
        <div class="container">
            ...
            <%
             ...
             <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="small text-muted"><%= list.get(i).getPostDate().substring(0,11) + list.get(i).getPostDate().substring(11,13)+"시"+list.get(i).getPostDate().substring(14,16)+"분"%></div>
                                    <h2 class="card-title h4"><a href="view.jsp?postID=<%=list.get(i).getPostID()%>"><%= list.get(i).getPostTitle()%></a></h2>
            ...
            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top" src="https://dummyimage.com/700x350/dee2e6/6c757d.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted"><%= list.get(i+1).getPostDate().substring(0,11) + list.get(i+1).getPostDate().substring(11,13)+"시"+list.get(i).getPostDate().substring(14,16)+"분"%></div>
                                    <h2 class="card-title h4"><a href="view.jsp?postID=<%=list.get(i+1).getPostID()%>"><%= list.get(i+1).getPostTitle()%></a></h2>
                                    <p class="card-text"><%= list.get(i+1).getUserID()%></p>
                                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla.</p>
                                    <a class="btn btn-primary" href="#!">Read more →</a>
                                </div>
             </div>
