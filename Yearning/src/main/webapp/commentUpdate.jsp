		...
		<div class="col-lg-10">
			<div class="jumbotron" style="padding-top: 1px;">				
				...
				<form name = c_commentUpdate>
					...
					<input type="button" onclick="send(<%=postID %>,<%=commentID %>)" value="수정">
					<br><br>
...
<script>
	...
	function send(postID,commentID){
		var sb;
		var commentText = document.c_commentUpdate.update.value;
		sb = "commentUpdateAction.jsp?postID="+postID+"&commentID="+commentID+"&commentText="+commentText;
